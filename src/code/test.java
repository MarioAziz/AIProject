...
//             if (currentNode.value.hostagesX[i] == currentNode.value.neoPositionX
//                     && currentNode.value.hostagesY[i] == currentNode.value.neoPositionY
//                     && currentNode.value.hostagesDmg[i] > 97) {
//                 noAction = true;
...
//                         || currentNode.getParent().action == null) {
...
//         MyTreeNode<matrixValue> currentNode = new MyTreeNode<matrixValue>(new matrixValue(currentString),"root");
//         hash.add(currentNode.value.hashValue());
//         do {
//             counter++;
//             currentNode = queue.remove();
//             matrixValue=new matrixValue(currentNode);
...
//             }
//         }
//         for (boolean dmg : currentNode.value.agentDead) {
//             if (dmg) {
//                 agentDead++;
//             }
//         }
//         for (MyTreeNode<matrixValue> child : currentNode.getChildren()) {
...
//         int counter = 0;
//         HashSet<String> hash = new HashSet<>();
//         LinkedList<MyTreeNode<matrixValue>> queue = new LinkedList<>();
